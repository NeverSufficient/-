											...
											<fieldset>
												<label class="block clearfix">
													...
													<input type="text" class="form-control" placeholder="课程号"
															id="login-id" name="cno" />
													</span>
												</label>
												<label class="block clearfix">
													<span class="block input-icon input-icon-right">
														<input type="text" class="form-control" placeholder="课程名"
															id="login-name" name="cname" />
													</span>
												</label>
												<label class="block clearfix">
													<span class="block input-icon input-icon-right">
														<input type="text" class="form-control" placeholder="学分数"
															id="login-name" name="ccredit" />
													</span>
												</label>
												<label class="block clearfix">
													<span class="block input-icon input-icon-right">
														<input type="text" class="form-control" placeholder="课程简介"
															id="login-name" name="cintroduction" />
													</span>
												</label>
												<div class="space"></div>
												<div class="clearfix">
